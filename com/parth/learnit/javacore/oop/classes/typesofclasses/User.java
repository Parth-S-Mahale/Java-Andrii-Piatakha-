...
import com.parth.learnit.javacore.oop.classes.Product;

public class User {
	
	public static final int DISCOUNT_THRESHOLD_INR = 1000;
	...
	public double calculateDiscount() {
		...
		if (totalPriceAllProductsBought >= DISCOUNT_THRESHOLD_INR) {
